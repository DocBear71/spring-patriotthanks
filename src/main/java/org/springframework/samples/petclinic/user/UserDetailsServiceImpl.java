 ...
 *
 * <p>
 * This service is marked as {@link Primary} so that it takes precedence over any
 * other {@link UserDetailsService} beans in the application context. It translates
 * the application's {@link User} entity into a Spring Security
 * {@link org.springframework.security.core.userdetails.User} object.
 * </p>
 *
 * <p>
 * Soft-deleted accounts (where {@code deletedAt} is not {@code null}) are treated
 * as non-existent to prevent former users from logging back in.
 * </p>
 *
 * @author Edward
 */
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	/**
	 * Loads a {@link UserDetails} object by the user's email address for
	 * Spring Security authentication.
	 *
	 * <p>
	 * If no user is found with the given email, or if the user's account has
	 * been soft-deleted (i.e., {@code deletedAt} is not {@code null}), a
	 * {@link UsernameNotFoundException} is thrown. The generic error message
	 * prevents malicious actors from determining which emails are registered
	 * or which accounts have been deleted.
	 * </p>
	 *
