...
public class BusinessController {
	...
	public String processCreationForm(@Valid Business business, BindingResult result, Model model) {
		...
		// Note: The slug is auto-generated by @PrePersist in Business.java
	 ...
	 * Throws a 404 if no business matches the slug.
	 *
	 * <p>
	 * Example: {@code /businesses/olive-garden} displays the Olive Garden business
	 * details.
	 * </p>
	 * @param slug the URL-friendly slug derived from the business name (e.g.,
	 * "olive-garden")
	 ...
	 * data. Only accessible to users with the {@code MANAGE_BUSINESSES} permission, which
	 * is enforced by {@link PatriotSecurityConfig}.
	 ...
	 * preserves fields that should not be changed via the form (verified status, active
	 * status, created-by), and persists the updated business.
	...
	public String processUpdateForm(@Valid Business business, BindingResult result,
		...
		// Preserve fields that the edit form does not expose
		...
		// Redirect to the slug URL (slug is regenerated by @PreUpdate)
